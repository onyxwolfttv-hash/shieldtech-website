    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          Elevating Your
          <motion.span
            className="block font-semibold text-gold mt-2"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <button
            ...
            className="group relative px-10 py-4 bg-gold text-black font-semibold text-sm tracking-widest uppercase overflow-hidden transition-all duration-400 hover:shadow-[0_20px_40px_rgba(212,175,55,0.3)] hover:-translate-y-1"
          >
            <span className="relative z-10">Schedule Consultation</span>
            <div className="absolute inset-0 bg-gold-dark transform scale-x-0 group-hover:scale-x-100 transition-transform duration-400 origin-left" />
          </button>

          {/* Secondary Button */}
          <button
            onClick={() => scrollToSection('#services')}
            className="group relative px-10 py-4 border border-white/30 text-white font-semibold text-sm tracking-widest uppercase overflow-hidden transition-all duration-400 hover:border-gold hover:text-gold"
          >
            <span className="relative z-10 flex items-center gap-2 justify-center">
              Explore Services
              <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform duration-300" />
            </span>
            <div className="absolute inset-0 bg-white/5 transform translate-y-full group-hover:translate-y-0 transition-transform duration-400" />
          </button>
        </motion.div>
      </div>
